//
//  CCQUserFeedBackViewController.m
//  DazzleLight
//
...
#import "CCQPlaceholderTextView.h"
#import "CCQPhotoCollectionViewCell.h"
#define kTextBorderColor     RGBCOLOR(227,224,216)

#undef  RGBCOLOR
#define RGBCOLOR(r,g,b) [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:1]
@interface CCQUserFeedBackViewController ()<UITextViewDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
@property (nonatomic, strong) CCQPlaceholderTextView * textView;
...
@implementation CCQUserFeedBackViewController
...
-(void)addCollectionViewPicture{
    ...
    //注册对应的cell
    [_collectionV registerClass:[CCQPhotoCollectionViewCell class] forCellWithReuseIdentifier:@"cell"];
...
-(CCQPlaceholderTextView *)textView{
    
    if (!_textView) {
        _textView = [[CCQPlaceholderTextView alloc]initWithFrame:CGRectMake(0, 0, self.view.frame.size.width - 40, 100)];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    CCQPhotoCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"cell" forIndexPath:indexPath];
